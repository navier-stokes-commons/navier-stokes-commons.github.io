...
def _r5_copy(loc:str):
    copies={
      'en':{
        ...
        'play':'Play sweep','pause':'Pause sweep','speed':'sweep speed','frame':'Normalized core frame','frame_lab':'Laboratory frame',
      ...
      'es':{
        ...
        'play':'Reproducir barrido','pause':'Pausar barrido','speed':'velocidad del barrido','frame':'Vista normalizada','frame_lab':'Vista de laboratorio',
...
def main():
    ...
    (PUBLIC/'assets').mkdir()
    shutil.copy2(ASSETS/'style.css',PUBLIC/'assets/style.css'); shutil.copy2(ASSETS/'site.js',PUBLIC/'assets/site.js'); shutil.copy2(ASSETS/'r17-fluid.js',PUBLIC/'assets/r17-fluid.js')
